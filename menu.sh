...
git config --global user.name "tgwl" # 记得替换用户名为自己的
git config --global user.email "tg2521150881@gmail.com" # 记得替换邮箱为自己的
ssh-keygen -t rsa -C tg2521150881@gmail.com # 记得替换邮箱为自己的
